    ...
    >
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid gap-6 mt-10 mb-8' style={{ gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))" }}>
          ...
          <input type='text' placeholder='Enter your email' required className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:text-black' name='email'/>
        </div>
        <textarea rows='6' placeholder='Enter your message' required className='w-full p-4 outlne-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6  dark:text-black' name='message'></textarea>
